    ...
    data() {
        return {
            ...
            basessarr: [
                ...
                { 'title': 'Linux笔记(PDF)', 'url': './item/documentword/linux/Linux知识点总结(课程版).pdf' },
    ...
    data() {
        return {
            ...
            basessarr: [
                ...
                { 'title': '星穹铁道', 'desc': '星穹铁道', 'url': 'https://sr.mihoyo.com/', 'src': './images/navlogo/game/xingtie.ico' },
    ...
    data() {
        return {
            ...
            basessarr: [
                ...
                { 'title': 'window常见错误', 'url': './item/tips/window常见错误.html' },
