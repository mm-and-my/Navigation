 function calc(func) {
        ...
        /*var num2 =    (12)    (document.getElementById('num2').value);*/
				var result = document.querySelector("#result"); /*通过id获取存放结果的DOM元素*/
        var num1 = parseFloat(document.getElementById('num1').value);/*将字符串转换成数字*/
        var num2 = parseFloat(document.getElementById('num2').value);/*将字符串转换成数字*/
