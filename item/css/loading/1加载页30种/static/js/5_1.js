...
(function(u, r) { "function" === typeof define && define.amd ? define([], r) : "object" === typeof module && module.exports ? module.exports = r() : u.anime = r() })(this, function() {
    function u(a) { if (!h.col(a)) try { return document.querySelectorAll(a) } catch (b) {} }

    function r(a) { return a.reduce(function(a, c) { return a.concat(h.arr(c) ? r(c) : c) }, []) }
    ...
    function R(a) {
        a = a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(a, b, c, g) { return b + b + c + c + g + g });
    ...
    function G(a, b) { return h.fnc(a) ? a(b.target, b.id, b.total) : a }

    function B(a, b) { if (b in a.style) return getComputedStyle(a).getPropertyValue(b.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()) || "0" }

    function H(a, b) { if (h.dom(a) && E(U, b)) return "transform"; if (h.dom(a) && a.getAttribute(b)) return "attribute"; if (h.dom(a) && "transform" !== b && B(a, b)) return "css"; if (null != a[b]) return "object" }
    ...
    function V(a, b) {
        ...
        a = a.style.transform;
        if (!a) return c;
        for (var d = [], e = [], k = [], g = /(\w+)\((.+?)\)/g; d = g.exec(a);) e.push(d[1]), k.push(d[2]);
    ...
    function L(a) { return (a ? r(h.arr(a) ? a.map(v) : v(a)) : []).filter(function(a, c, d) { return d.indexOf(a) === c }) }
    ...
    function Z(a, b) {
        ...
        if (h.arr(a)) {
            var d = a.length;
            2 !== d || h.obj(a[0]) ? h.fnc(b.duration) || (c.duration = b.duration / d) : a = { value: a }
        }
    ...
    function aa(a, b) {
        ...
        for (d in a) {
            var e = G(a[d], b);
            h.arr(e) && (e = e.map(function(a) { return G(a, b) }), 1 === e.length && (e = e[0]));
            c[d] = e
        }
    ...
    function ba(a) { return h.arr(a) ? x.apply(this, a) : M[a] }
    ...
    function da(a, b) {
        ...
        })).filter(function(a) { return !h.und(a) })
    }

    function N(a,
        b, c) { var d = "delay" === a ? Math.min : Math.max; return b.length ? d.apply(Math, b.map(function(b) { return b[a] })) : c[a] }
    ...
    function ea(a) {
        var b = F(fa, a),
            ...
            k = A(b, c),
            g;
        for (g in a) k.hasOwnProperty(g) || "targets" === g || e.push({ name: g, offset: k.offset, tweens: Z(a[g], c) });
        a = da(d, e);
    ...
    function m(a) {
        ...
        function d(a) {
            for (var b = 0, c = {}, d = f.animations, e = {}; b < d.length;) {
                var g = d[b],
                    h = g.animatable,
                    k = g.tweens;
                e.tween = k.filter(function(b) { return a < b.end })[0] || k[k.length - 1];
                ...
                k = X(e.tween.to.numbers.map(function(a) {
                    return function(b, c) {
            ...
            if (c)
                for (var l in c) D || (D = B(document.body, "transform") ? "transform" : "-webkit-transform"), f.animatables[l].target.style[D] = c[l].join(" ");
            f.currentTime = a;
        ...
        function k() { f.remaining && !0 !== f.remaining && f.remaining-- }
        ...
        function g(a) {
            ...
            q > n && q < g ? (d(q), !f.began && q >= m && (f.began = !0, e("begin")), e("run")) : (q <= n && 0 !== O && (d(0), p && k()), q >= g && O !== g && (d(g), p || k()));
            a >= g && (f.remaining ? (t = h, "alternate" === f.direction && (f.reversed = !f.reversed)) : (f.pause(), P(), Q = b(), f.completed || (f.completed = !0, e("complete"))), l = 0);
            if (f.children)
    ...
    var fa = { update: void 0, begin: void 0, run: void 0, complete: void 0, loop: 1, direction: "normal", autoplay: !0, offset: 0 },
        ...
        x = function() {
            ...
            return function(b, c, d, e) {
                if (0 <= b && 1 >= b && 0 <= d && 1 >= d) {
                    ...
                    if (b !== c || d !== e)
                        for (var g = 0; 11 > g; ++g) k[g] = a(.1 * g, b, d);
                    return function(g) {
                        if (b === c && d === e) return g;
                        if (0 === g) return 0;
                        if (1 === g) return 1;
                        for (var h = 0, l = 1; 10 !== l && k[l] <= g; ++l) h += .1;
                        --l;
                        var l = h + (g - k[l]) / (k[l + 1] - k[l]) * .1,
                        ...
                        if (.001 <= n) {
                            ...
                            var l = h,
                                h = h + .1,
                                f = 0;
                            do m = l + (h - l) / 2, n = a(m, b, d) - g, 0 < n ? h = m : l = m; while (1e-7 < Math.abs(n) && 10 > ++f);
                            g = m
                        }
                        return a(g, c, e)
                    }
        ...
        M = function() {
            ...
            var b = "Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split(" "),
                ...
                e = {},
                k;
            for (k in c) e.type = k, c[e.type].forEach(function(a) { return function(c, e) { d["ease" + a.type + b[e]] = h.fnc(c) ? c : x.apply($jscomp$this, c) } }(e)), e = { type: e.type };
            return d
        }(),
        ha = {
            css: function(a, b, c) { return a.style[b] = c },
            attribute: function(a, b,
                c) { return a.setAttribute(b, c) },
    ...
    m.remove = function(a) {
        ...
        for (var b = p.length - 1; 0 <= b; b--)
            for (var c = p[b], d = c.animations, e = d.length - 1; 0 <= e; e--) E(a, d[e].animatable.target) &&
                (d.splice(e, 1), d.length || c.pause())
    };
    m.getValue = I;
    m.path = function(a, b) {
